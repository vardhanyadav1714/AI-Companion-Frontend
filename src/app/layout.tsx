...
export const metadata: Metadata = { title: { default: "Eva - Your AI companions", template: "%s | Eva" }, description: "Your own little corner for thoughtful conversations with AI companions." };
